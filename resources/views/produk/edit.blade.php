                    ...
                    <form id="formAddProduct" novalidate>
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_produk" class="form-control"
                                placeholder="Masukkan Nama Produk" value="Koi Kohaku Jumbo" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi_produk" class="form-control" cols="4" rows="6"
                                placeholder="Masukkan Deskripsi Produk" required>Koi Kohaku berkualitas tinggi dengan corak merah dan putih simetris. Cocok untuk kontes maupun koleksi pribadi.
                            </textarea>
                            <div class="invalid-feedback">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="Collection"
                                placeholder="Masukkan Ukuran Produk" value="50 cm" required>
                            <div class="invalid-feedback">
                                Ukuran wajib diisi.
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" id="harga_produk"
                                placeholder="Masukkan Harga Produk" value="3500000" required>
                            <div class="invalid-feedback">
