                ...
                <div class="col-12 col-xl-5 col-xxl-4 auth-cover-right align-items-center justify-content-center">
                    <div class="m-3 mb-0 border-0 shadow-none card rounded-0">
                        <div class="card-body p-sm-5">
                            ...
                            <h2 class="text-center fw-bold">Login Akun</h2>
                            ...
                            @endif
                            <p class="mb-0 text-center">Masuk dengan akun yang telah anda buat sebelumnya!</p>
                            ...
                            <div class="mt-4 form-body">
                                <form class="row g-3" action="{{ route('login.submit.buyer') }}" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        Belum sudah punya akun? Buat akun lewat sini <u><a href="{{ route('registrasi.buyer') }}">Login</a></u>
                                    </div>
                                </form>
                            </div>
                        </div>
