...
<head>
    ...
    <title>Buat Akun | Azza Koi Farm</title>
    <!--favicon-->
                            ...
                            <div class="mt-4 form-body">
                                <form class="row g-3" action="{{ route('registrasi.submit') }}" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        sudah punya akun? masuk lewat sini <u><a href="{{ route('login.buyer') }}">Login</a></u>
                                    </div>
                                </form>
                            </div>
                        </div>
